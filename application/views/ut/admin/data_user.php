            ...
            <div class="col-lg-9">
                <div class="card shadow">
                    <div class="card-header bg-info">
                        <i class="fas fa-users-cog"></i> <strong>Data User</strong>
                        <div class="row float-right">
                            <button data-toggle="modal" data-target="#add_user" class="btn bg-navy btn-block btn-xs"><i class="fa fa-plus"></i> Tambah User</button>
                        </div>
                    </div>
                    <!-- START CARD BODY -->
                    <div class="card-body p-2" style="display: block;">
                        ...
                        <?php elseif ($this->session->flashdata('flash_gagal') == TRUE) : ?>
                            <div class="alert alert-danger"><small><i class="fa fa-exclamation-circle"></i> Username sudah ada! <strong>Gagal</strong> ditambah</small></div>
                        <?php elseif ($this->session->flashdata('flash_del') == TRUE) : ?>
                            <div class="alert alert-success"><small><i class="fa fa-exclamation-circle"></i> User <strong>Berhasil</strong> dihapus</small></div>
                        <?php elseif ($this->session->flashdata('flash_gagal_del') == TRUE) : ?>
                            <div class="alert alert-danger"><small><i class="fa fa-exclamation-circle"></i> Username ini sedang <strong>Login!</strong>, gagal dihapus</small></div>
                        <?php endif; ?>

                        <table class="datatabledong table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Username <?= $this->session->userdata('id');?></th>
                                    <th>Nama</th>
                                    <th>NIM</th>
                                    <th>Alamat</th>
                                    <th>Telp</th>
                            ...
                            <tbody>
                                <?php foreach ($data_user as $du) { ?>
                                    <tr>
                                        ...
                                        <td><?= $du->prodi; ?></td>
                                        <td><?= $du->level; ?></td>
                                        <td><a href="javascript:;" data-id="<?= $du->id; ?>" data-email="<?= $du->email; ?>" data-username="<?= $du->username; ?>" data-nama="<?= $du->nama; ?>" data-nim="<?= $du->nim; ?>" data-alamat="<?= $du->alamat; ?>" data-telp="<?= $du->telp; ?>" data-prodi="<?= $du->prodi; ?>" data-level_id="<?= $du->level_id; ?>" data-level="<?= $du->level; ?>" data-toggle="modal" data-target="#edit-data">
                                                <button data-toggle="modal" data-target="#ubah-data" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></button>
                                            </a>
                                            <a href="<?= base_url('admin/del_user/' . $du->id); ?>" class="hapus btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
